...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 06, 2017 at 12:29 AM
...
INSERT INTO `tbl_city` (`c_id`, `c_name`) VALUES
(1, 'Nelson'),
(2, 'Christchurch'),
(3, 'Dunedin'),
(4, 'Auckland'),
...
INSERT INTO `tbl_property` (`p_id`, `p_title`, `p_address`, `p_c_id`, `p_bed`, `p_bath`, `p_garage`, `p_price`, `p_type`) VALUES
(1, 'Many Rooms & Spaces for the Money', '57 Masefield Street', 1, 4, 2, 2, '467000.00', 1),
(2, 'Two Houses, One Wife…. One Must Go!', '364 Nayland Road', 1, 4, 2, 2, '500000.00', 2),
(3, 'Honest To Goodness Family Living!', '18 Sunningdale Drive', 2, 4, 2, 2, '434000.00', 3),
(4, 'A Modern Classic', '1 Sunningdale Drive', 2, 4, 2, 2, '422000.00', 1),
(5, 'Ripe for Reno and Below RV', '83 Princes Drive', 3, 3, 2, 2, '341200.00', 1),
(6, 'The Work Here Is Done - Move In Ready', '13 Windsor Drive', 4, 4, 1, 2, '796000.00', 2),
(7, 'Quick, put the bubbly on ice!', '396 Princes Drive', 1, 3, 2, 2, '332650.00', 1),
(8, 'Enduring Nelson Icon', '8 Whitby Road', 5, 5, 2, 1, '511000.00', 3),
(9, 'Nice N Easy', '35a Vernall Street', 1, 2, 1, 1, '450000.00', 2),
(10, 'Investors! 4 Bedroom Plus Office', '78a Grandview Road', 3, 4, 1, 0, '395204.00', 3);
