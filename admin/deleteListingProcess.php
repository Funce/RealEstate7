<?php 
	...
	if(isset($_POST['submit']))
	{
		...
		$query = "DELETE FROM tbl_property WHERE p_id = $property_id";
		mysqli_query($link, $query);
		$query = "DELETE FROM tbl_image WHERE i_p_id = $property_id";
		mysqli_query($link, $query);
		header("Location: index.php");
	}
...
<div class="container">
  <div class="row">
	...
	<fieldset>
		<!-- Form Start -->
		<legend>Are you sure you wish to delete this Listing?</legend> 
		<br>
